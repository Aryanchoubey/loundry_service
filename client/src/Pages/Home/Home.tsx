import { Anvil, BedDouble, Lock, Mail, Shirt, User, WashingMachine } from "lucide-react";
...
const services = [
  ...
  title: "Wash & Fold",
  description: "Basic wash and fold service with gentle detergent, proper drying, and neatly folded clothes ready to wear or store.",
  item: "1 Item",
  price: "₹15",
}
,
 {
  ...
  title: "Dry Cleaning",
  description: "Professional dry cleaning service with fabric-friendly solutions, gentle care for delicate clothes,  fresh finish.",
  item: "1 Item",
  price: "₹20",
}
,
 {
  ...
  title: "Ironing",
  description: "Professional ironing service ensuring wrinkle-free, and well-pressed clothes with fabric-safe techniques.",
  item: "1 Item",
  price: "₹10",
}
,
 {
  ...
  title: "Bedding",
  description: "Fresh and hygienic cleaning for comforters,  and bed sheets, ensuring softness and long-lasting freshness.",
  item: "1 Item",
  price: "₹25",
}
,
